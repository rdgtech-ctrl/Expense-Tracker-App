...
import { RefreshCw, Info, ChevronUp } from 'lucide-react'
import { Clock, CreditCard, ArrowUp, Activity, Zap, Gift, ShoppingCart, Car, Home, Utensils, ArrowDown, DollarSign, PiggyBank, TrendingUp, RefreshCcw } from 'lucide-react'
      ...
      <div className={styles.layout.mainContainer(sidebarCollapsed)}>
        ...
        <div className={styles.statCards.grid}>
          <div className={styles.statCards.card}>
            <div className={styles.statCards.carHeader}>
              <div>
        ...
        <div className={styles.grid.main}>
          ...
          <div className={styles.grid.rightColumn}>
            ...
            <div className={styles.cards.base}>
              ...
              <div className={styles.categories.sum}>
