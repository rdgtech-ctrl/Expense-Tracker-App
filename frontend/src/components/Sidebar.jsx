...
import { X, Menu, ArrowDown, ArrowUp, HelpCircle, Home, LogOut, User } from 'lucide-react'
...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
    ...
    //[mobileOpen] is the dependent array - it tells react:
    //"Re-run this effect every time mobileOpen changes"
    ...
    return (
        <>
            ...
            >
                <div className={sidebarStyles.sidebarInner.base}>
                    ...
                    >
                        ...
                        {/* cn is a utility function that combines multiple class names into one string. UTILITY FUNCTION IS A SMALL,REUSABLE HELPER FUNCTION THAT DOES ONE SIMPLE JOB AND CAN BE USED ANYWERE IN YOUR PROJECT*/}
                        {!isCollapsed && (
                            <motion.div
                    ...
                    >
                        <Link
                            ...
                            to="https://github.com/rdgtech-ctrl/Expense-Tracker-App.git"
                        >
            ...
            <motion.button
                ...
                className={sidebarStyles.mobileMenyButton}
