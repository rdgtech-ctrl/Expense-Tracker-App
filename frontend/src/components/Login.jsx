...
const Login = ({ onLogin, API_URL = "http://localhost:4000" }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!profile) {
                const copy = { ...data }; // it creates a copy of th data object. helping in to avoid manipulation with the original data
                delete copy.token;
                delete copy.user;
                ...
                <div className={loginStyles.formContainer}>
                    ...
                    <div className={loginStyles.signUpContainer}>
                        <p className={loginStyles.signUpText}>
                            ...
                            {/* {" "} is just adding a single space between the text and the link */}
